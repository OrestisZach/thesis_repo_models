...
class DeformableTransformer(nn.Module):
    ...
    def forward(self, srcs, masks, pos_embeds, query_embed=None, sentence_embeds=None, ref_pts=None, ref_angles=None):
        ...
        if self.two_stage:# False
            ...
            # Support both legacy shared queries (Q, 2C) and per-sample
            # proposal-driven queries (B, Q, 2C).
            ...
            if ref_pts is None: # what is rference_points
                ...
                # Support legacy shared refs (Q, 2/4) and per-sample refs (B, Q, 2/4).
                if ref_pts.dim() == 2:
...
class DeformableTransformerDecoderLayer(nn.Module):
    ...
    def _forward_self_cross(self, tgt, query_pos, reference_points, src, src_spatial_shapes, level_start_index,
                            src_padding_mask=None, attn_mask=None, lvl_pos_embed_flatten=None, ref_angles=None):
    ...
    def forward(self, tgt, query_pos, reference_points, src, src_spatial_shapes, level_start_index,
                src_padding_mask=None, lvl_pos_embed_flatten=None, ref_angles=None):
        attn_mask = None
        ...
        return self._forward_cross_self(tgt, query_pos, reference_points, src, src_spatial_shapes, level_start_index,
                                        src_padding_mask, attn_mask, lvl_pos_embed_flatten, ref_angles=ref_angles)
    ...
    def forward(self, tgt, reference_points, src, src_spatial_shapes, src_level_start_index, src_valid_ratios,
        ...
        for lid, layer in enumerate(self.layers):
            ...
            output = layer(output, query_pos, reference_points_input, src, src_spatial_shapes, src_level_start_index,
                           src_padding_mask, lvl_pos_embed_flatten, ref_angles=ref_angles)
